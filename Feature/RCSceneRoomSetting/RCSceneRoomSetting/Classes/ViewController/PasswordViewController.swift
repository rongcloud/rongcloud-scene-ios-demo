...
class PasswordViewController: UIViewController {
    ...
    private lazy var titleLabel: UILabel = {
        ...
        instance.textColor = "Hex020037".color
    ...
    private lazy var cancelButton: UIButton = {
        ...
        instance.setTitleColor("Hex020037".color, for: .normal)
    ...
    private lazy var separatorLine1: UIView = {
        let instance = UIView()
        instance.backgroundColor = "HexE5E6E7".color
        return instance
    }()
    ...
    init(_ delegate: RCSceneRoomSettingProtocol?) {
