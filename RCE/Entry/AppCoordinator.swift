...
//    //FIXEME: just for test
//        super.init(tabs: [community,recreational, discoverNew,message, profile], select: recreational)
//    //END
        ...
        let count1 = RCIMClient.shared().getUnreadCount([RCConversationType.ConversationType_PRIVATE.rawValue])

        let count2 = RCIMClient.shared().getUnreadCount([RCConversationType.ConversationType_SYSTEM.rawValue])
