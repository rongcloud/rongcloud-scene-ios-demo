...
extension RCRadioRoomViewController {
    func didRequestJoinOtherRoom(_ inviterRoomId: String, inviterUserId: String, extra: String) {
    ...
    func didResponseJoinOtherRoom(_ inviterRoomId: String, inviterUserId: String, inviteeRoomId: String, inviteeUserId: String, agree: Bool, extra: String) {
    ...
    func didFinishOtherRoom(_ roomId: String, userId: String) {
