...
class RCMHBeautyView: UIView {
    ...
    private lazy var sticker = RCMHStickerViewController(manager)
    private lazy var retouch = RCMHRetouchViewController(manager)
    private lazy var makeup = RCMHMakeupViewController(manager)
    private lazy var effect = RCMHEffectViewController(manager)
