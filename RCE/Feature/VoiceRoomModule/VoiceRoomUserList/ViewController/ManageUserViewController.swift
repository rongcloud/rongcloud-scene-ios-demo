...
protocol ManageUserProtocol: AnyObject {
...
struct ManageUserDependency {
    let roomId: String
    let roomCreator: String
    var managelist: [String] {
        get {
            return VoiceRoomSharedContext.shared.managerlist
        }
    }
    ...
    var seatInfolist: [RCVoiceSeatInfo] {
        get {
            return VoiceRoomSharedContext.shared.seatlist
        }
    }
...
class ManageUserViewController: UIViewController {
    ...
    private var dependency: ManageUserDependency
    weak var delegate:ManageUserProtocol?
    ...
    init(dependency: ManageUserDependency, delegate: ManageUserProtocol?) {
    ...
    private func fetchUserInfo() {
        UserInfoDownloaded.shared.fetchUserInfo(userId: dependency.presentUserId) { [weak self] user in
    ...
    private func buildLayout() {
        ...
        giftButton.snp.makeConstraints { make in
            make.left.equalToSuperview().offset(39.resize)
        ...
        sendMessageButton.snp.makeConstraints { make in
            ...
            make.right.equalToSuperview().inset(30.resize)
        }
