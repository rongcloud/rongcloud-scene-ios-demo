...
public protocol ChangeBackgroundImageProtocol: AnyObject {
    func didConfirmImage(urlSuffix: String)
}

public class ChangeBackgroundViewController: UIViewController {
    ...
    public init(imagelist: [String], delegate: ChangeBackgroundImageProtocol) {
