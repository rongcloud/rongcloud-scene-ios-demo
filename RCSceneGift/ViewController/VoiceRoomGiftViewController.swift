...
public protocol VoiceRoomGiftViewControllerDelegate: AnyObject {
    func didSendGift(message: RCMessageContent)
}

public struct VoiceRoomGiftDependency {
    let room: VoiceRoom
    let seats: [String]
    let userIds: [String]
    ...
    public init(room: VoiceRoom, seats: [String], userIds: [String]) {
        self.room = room
        self.seats = seats
...
public final class VoiceRoomGiftViewController: UIViewController {
   ...
   public init(dependency: VoiceRoomGiftDependency, delegate: VoiceRoomGiftViewControllerDelegate) {
...
extension VoiceRoomGiftViewController: VoiceRoomGiftSeatsViewDelegate {
    public func giftSeatsView(_ view: VoiceRoomGiftSeatsView, didSelected seats: [VoiceRoomGiftSeat]) {
        self.seats = seats
    }
}
