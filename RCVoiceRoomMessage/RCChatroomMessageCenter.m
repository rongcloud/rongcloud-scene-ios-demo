...
+ (void)registerMessageTypes {
    [RCClient registerMessageType:[RCChatroomEnter class]];
    [RCClient registerMessageType:[RCChatroomLeave class]];
    ...
    [RCClient registerMessageType:[RCVRVoiceMessage class]];
    [RCClient registerMessageType:[RCChatroomFollow class]];
}
