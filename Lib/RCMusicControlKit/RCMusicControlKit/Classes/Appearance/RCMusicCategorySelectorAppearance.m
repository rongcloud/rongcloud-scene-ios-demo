...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.normalFont = cta.labelAttributes.normalFont.appearanceValue ?: [UIFont systemFontOfSize:16];
        self.selectedFont = cta.labelAttributes.selectedFont.appearanceValue ?: [UIFont boldSystemFontOfSize:16];
