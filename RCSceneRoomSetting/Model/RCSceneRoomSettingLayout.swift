...
/// A horizontal alignment used internally by `RCSceneRoomSettingFlowLayout`
...
open class RCSceneRoomSettingFlowLayout: UICollectionViewFlowLayout {
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func isRepresentingFirstItemInLine(collectionViewLayout: RCSceneRoomSettingFlowLayout) -> Bool {
        if currentItem <= 0 {
            return true
        }
        else {
    ...
    func isRepresentingLastItemInLine(collectionViewLayout: RCSceneRoomSettingFlowLayout) -> Bool {
    ...
    private func alignToPrecedingItem(collectionViewLayout: RCSceneRoomSettingFlowLayout) {
    ...
    ///
    /// - Parameter collectionViewLayout: The layout on which to perfom the calculations.
    private func alignToFollowingItem(collectionViewLayout: RCSceneRoomSettingFlowLayout) {
        let itemSpacing = collectionViewLayout.minimumInteritemSpacing
    ...
    func alignHorizontally(collectionViewLayout: RCSceneRoomSettingFlowLayout) {
    ...
    func alignVertically(collectionViewLayout: RCSceneRoomSettingFlowLayout) {
