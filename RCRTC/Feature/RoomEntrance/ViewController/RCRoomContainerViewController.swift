...
extension RCRoomContainerViewController {
    private func refresh() {
        guard currentScene.rawValue == SceneRoomManager.scene else {
            return header.endRefreshing()
        }
    ...
    private func more() {
        guard currentScene.rawValue == SceneRoomManager.scene else { return header.endRefreshing() }
